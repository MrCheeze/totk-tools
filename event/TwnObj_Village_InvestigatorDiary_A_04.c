-------- EventFlow: TwnObj_Village_InvestigatorDiary_A_04 --------
...
void Talk() {
    ...
    GameDataActor.EventTriggerSetGameDataBool({'GameDataName': 'Know_FourStonePlates_KnowPlates01', 'Index': -1, 'Value': True})
}
