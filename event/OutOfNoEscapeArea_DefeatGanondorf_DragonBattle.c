-------- EventFlow: OutOfNoEscapeArea_DefeatGanondorf_DragonBattle --------
...
Actor: Player
entrypoint: None()
actions: ['EventPlayerWarpToTargetPosAndRot', 'EventPlayerWait', 'EventTriggerPlayerClimbOff', 'EventPlayerHorseGetOff', 'EventPlayerStopInAir', 'EventPlayerRideDragon', 'EventTriggerClearModelBindAndDependency']
