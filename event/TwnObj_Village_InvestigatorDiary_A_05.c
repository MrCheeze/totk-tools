-------- EventFlow: TwnObj_Village_InvestigatorDiary_A_05 --------
...
void Talk() {
    ...
    GameDataActor.EventTriggerSetGameDataBool({'GameDataName': 'Know_FourStonePlates_KnowPlates03', 'Index': -1, 'Value': True})
}
