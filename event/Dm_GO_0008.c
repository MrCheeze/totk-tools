...
void EntryPoint0() {
    ...
    Npc_Goron_Yunbo_Sage_Puppet.EventTriggerEmitXLink({'ELinkKey': 'Dm_GO_0008_MaskCrack_Lv1', 'SLinkKey': 'Dm_AccessoryBreakSmall'})
    Npc_Goron_Yunbo_Sage_Puppet.EventPlayAS({'ASName': 'AccessoryBreakSmall', 'IsWaitEnd': True, 'IsAllSlot': False, 'ForceFadeInFrame': -1.0, 'IsAnimeDriven': False, 'Partial': 'Accessory'})
    GameSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 45})
