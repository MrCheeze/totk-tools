-------- EventFlow: FldObj_SignboardStone_A_06 --------
...
void Talk() {
    ...
    GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': True, 'GameDataName': 'TreasureOfLambda_DreamThunder_ReadMessage'})
}
