-------- EventFlow: MinusYiga_KohgaContinueBattleEnd --------
...
Actor: Player
entrypoint: None()
actions: ['EventTriggerParticipateEvent', 'EventPlayerWarpToNearAnchor']
queries: []
...
void BatttleEnd() {
    ...
    EventSystemActor.EventTransition({'IsWaitEnd': True, 'SpecialEventActionType': 1, 'FadeInTypeEventEnd': 0, 'EventName': 'Dm_OT_0017'})
    EventSystemActor.EventTransition({'IsWaitEnd': True, 'SpecialEventActionType': 1, 'FadeInTypeEventEnd': 0, 'EventName': 'MinusYiga_KohgaContinueBattleEnd_Golem'})
}

void BatttleEnd_Golem() {

    call Npc_Zonau_Golem_Servant_Minus0004.AfterBattle()
