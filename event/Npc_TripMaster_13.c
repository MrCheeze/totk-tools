...
void Talk() {
    ...
    call Npc_TripMaster_00.Shop_Talk({'MessageId': 'EventFlowMsg/Npc_TripMaster_13:Com_Talk_Hello'})
    ...
    switch Npc_EventStarter.EventQueryAIScheduleCheckActorAction14() {
      case [0, 2]:
        if !Npc_EventStarter.EventQueryIsIndoor() {
            Event2:
            Npc_EventStarter.EventTriggerBalloonMessage({'IsChallenge': False, 'DisplayFrame': 90, 'IsIgnoreDisplayKeepDepth': False, 'MessageID': 'EventFlowMsg/Npc_TripMaster_13:Near1001', 'IsDisplayInTerror': False, 'NotOverriddenByInterestBalloon': False})
        } else
