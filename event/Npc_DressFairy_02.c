...
void Talk() {
    TwnObj_FairySpring_B_01.EventTriggerParticipateEvent()
    Player.EventTriggerParticipateEvent()

    call Npc_DressFairy_00.Fairy_Talk({'FairyActor': 'Npc_DressFairy_02', 'Starter_FairyActor': ActorIdentifier(name="Npc_DressFairy_02"), 'TargetPond': 'TwnObj_FairySpring_B_01'})
