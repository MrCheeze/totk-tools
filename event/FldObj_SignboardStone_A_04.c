-------- EventFlow: FldObj_SignboardStone_A_04 --------
...
void Talk() {
    ...
    GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': True, 'GameDataName': 'TreasureOfLambda_DreamStatue_ReadMessage'})
}
