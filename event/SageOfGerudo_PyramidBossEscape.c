-------- EventFlow: SageOfGerudo_PyramidBossEscape --------
...
entrypoint: None()
actions: ['EventTriggerRequestAutoSave', 'EventTriggerCloseCompanionLifeGauge']
queries: []
params: {'EventMemberCreateMethod': 0, 'IsGrounding': False, 'IsWorld': False, 'UseEventModelAnime': '', 'UseEventAS': '', 'IsBindNearestActor': False}
...
void EntryPoint0() {
    ...
    EventSystemActor.EventTransition({'IsWaitEnd': True, 'SpecialEventActionType': 1, 'FadeInTypeEventEnd': 0, 'EventName': 'Dm_GE_0017'})
