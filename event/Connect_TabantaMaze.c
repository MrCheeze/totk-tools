-------- EventFlow: Connect_TabantaMaze --------

Actor: DgnObj_Terminal_A_01[TabantaMazeSky5]
entrypoint: None()
actions: ['EventPlayAS']
queries: []
...
Actor: DgnObj_Terminal_A_08[TabantaMazeMinus]
entrypoint: None()
...
void ClearSky() {
    ...
    fork {
        ...
        DgnObj_Terminal_A_01[TabantaMazeSky5].EventPlayAS({'Partial': '', 'IsAnimeDriven': False, 'IsAllSlot': False, 'IsWaitEnd': False, 'ASName': 'Activate', 'ForceFadeInFrame': -1.0})
    }
    ...
    fork {
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0002', 'IsUnder': False})
    } {
    ...
    fork {
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'IsUnder': False, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0027'})
        GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': True, 'GameDataName': 'Connect_TabantaMaze_LandMiasma'})
    } {
    ...
    fork {
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'IsUnder': False, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0020'})
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0023', 'IsUnder': False})
    } {
        EventCamera.EventMoveToTargetPosCamera({'IsWaitEnd': True, 'Actor2ActorName': '', 'Actor2InstanceName': '', 'IsPosVectorReferenceActorPosOnce': False, 'IsAtVectorReferenceActorPosOnce': False, 'MoveTime': 0, 'StartAccelerateRate': 0.0, 'EndRecelerateRate': 0.0, 'IsLinearMove': False, 'MoveTotargetPosType': 0, 'TargetFovy': 60.0, 'PosVectorSetType': 3, 'AtVectorSetType': 3, 'CameraCollisionMode': 1, 'IsIgnorePosVectorReferenceActorRot': False, 'IsIgnoreAtVectorReferenceActorRot': False, 'LatShiftRange': 0.0, 'LongShiftRange': 0.0, 'Actor1ActorName': 'DesignateMatrixActor', 'PosVector': [-6.0, 6.0, 3.0], 'AtVector': [0.0, 1.0, 0.0], 'Actor1InstanceName': 'TabantaMaze', 'CameraCollisionLookAtActor': 0, 'CameraCollisionLookAtActorOffset': [0.0, 1.5, 0.0], 'EnableCameraAlpha': False})
    }

    EventRequestActor.EventTriggerSetEventBool({'Bool': True})
    EventCamera.EventMoveCameraToSavePoint({'IsWaitEnd': True, 'MoveFrame': 0, 'CollisionInterpolateSkip': False, 'ReviseMode': 0, 'EnableCameraAlpha': False})
    ChallengeSystemActor.EventExecuteProgressChallengeStep({'IsIgnoreCompletedChallenge': False, 'IsIgnoreChallengeProgressUI': False, 'StepName': 'Minus', 'ChallengeName': 'Connect_TabantaMaze', 'IsWaitEnd': True})
}
...
void ClearLand() {
    ...
    fork {
        ...
        DgnObj_Terminal_A_01.EventPlayAS({'Partial': '', 'IsAnimeDriven': False, 'IsAllSlot': False, 'IsWaitEnd': False, 'ASName': 'Activate', 'ForceFadeInFrame': -1.0})
    }
    ...
    fork {
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0019', 'IsUnder': False})
    } {
        Player.EventPlayerPlayASForFlowchart({'IsWaitEnd': False, 'UseAnmDriven': False, 'IsAllSlot': False, 'ASCommand': 'LookAround', 'KeepOneTimeAnm': False, 'ForceFadeFrame': -1.0, 'ClothWarpMode': 0})
    }
    ...
    fork {
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0012', 'IsUnder': True})
    } {
        EventCamera.EventMoveToTargetPosCamera({'IsWaitEnd': True, 'Actor1InstanceName': '', 'Actor2ActorName': '', 'Actor2InstanceName': '', 'IsPosVectorReferenceActorPosOnce': False, 'IsAtVectorReferenceActorPosOnce': False, 'StartAccelerateRate': 0.0, 'EndRecelerateRate': 0.0, 'IsLinearMove': False, 'MoveTotargetPosType': 0, 'LatShiftRange': 0.0, 'LongShiftRange': 0.0, 'Actor1ActorName': 'Player', 'PosVectorSetType': 3, 'AtVectorSetType': 3, 'IsIgnorePosVectorReferenceActorRot': False, 'IsIgnoreAtVectorReferenceActorRot': False, 'CameraCollisionMode': 0, 'TargetFovy': 50.0, 'MoveTime': 90, 'PosVector': [0.0, 15.0, -19.0], 'AtVector': [0.0, 25.0, -17.0], 'CameraCollisionLookAtActor': 0, 'CameraCollisionLookAtActorOffset': [0.0, 1.5, 0.0], 'EnableCameraAlpha': False})
    } {
    ...
    if !GameDataActor.EventQueryIsGameDataBool({'Index': -1, 'GameDataName': 'Connect_TabantaMaze_ReadStone'}) {
        ChallengeSystemActor.EventExecuteProgressChallengeStep({'IsIgnoreCompletedChallenge': False, 'IsIgnoreChallengeProgressUI': False, 'StepName': 'Land', 'ChallengeName': 'Connect_TabantaMaze', 'IsWaitEnd': True})
    } else {
        ChallengeSystemActor.EventExecuteProgressChallengeStep({'IsIgnoreCompletedChallenge': False, 'IsIgnoreChallengeProgressUI': False, 'ChallengeName': 'Connect_TabantaMaze', 'StepName': 'Land2', 'IsWaitEnd': True})
    }
}
...
void ClearMinus() {
    ...
    fork {
        ...
        DgnObj_Terminal_A_08[TabantaMazeMinus].EventPlayAS({'Partial': '', 'IsAnimeDriven': False, 'IsAllSlot': False, 'IsWaitEnd': False, 'ASName': 'Activate', 'ForceFadeInFrame': -1.0})
    }
    ...
    fork {
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0016', 'IsUnder': False})
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0017', 'IsUnder': False})
    } {
        Player.EventPlayerPlayASForFlowchart({'IsWaitEnd': False, 'UseAnmDriven': False, 'IsAllSlot': False, 'ASCommand': 'LookAround', 'KeepOneTimeAnm': False, 'ForceFadeFrame': -1.0, 'ClothWarpMode': 0})
    }
    ...
    fork {
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0018', 'IsUnder': False})
        GameSystemActor.EventOpenMessageDungeon({'IsWithAncientGlyph': True, 'IsWaitEnd': True, 'IsUnder': False, 'MessageID': 'EventFlowMsg/Connect_TabantaMaze:Talk_0026'})
    } {
    ...
    GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': True, 'GameDataName': 'Connect_TabantaMaze_TreasureAppear'})
...
void ClearMinusBefore() {
    ...
    fork {
        ...
        EventSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 30})
        DgnObj_Terminal_A_08[TabantaMazeMinus].EventPlayAS({'Partial': '', 'IsAnimeDriven': False, 'IsAllSlot': False, 'IsWaitEnd': False, 'ForceFadeInFrame': -1.0, 'ASName': 'Failure'})
    }

    EventSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 90})
    DgnObj_Terminal_A_08[TabantaMazeMinus].EventPlayAS({'Partial': '', 'IsAnimeDriven': False, 'IsAllSlot': False, 'IsWaitEnd': False, 'ForceFadeInFrame': -1.0, 'ASName': 'OffWait'})
    EventSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 30})
    EventCamera.EventMoveCameraToSavePoint({'IsWaitEnd': True, 'CollisionInterpolateSkip': False, 'ReviseMode': 0, 'MoveFrame': 0, 'EnableCameraAlpha': False})
    GameSystemActor.EventTriggerRequestAutoSave()
}
...
void DefeatEnemy() {
    ...
    DgnObj_Terminal_A_08[TabantaMazeMinus].EventTriggerParticipateEvent()
    EventCamera.EventTriggerCameraSavePoint()

    call FocusOnGimmick.BasicNoSE()

    DgnObj_Terminal_A_08[TabantaMazeMinus].EventPlayAS({'Partial': '', 'IsAnimeDriven': False, 'IsAllSlot': False, 'IsWaitEnd': False, 'ForceFadeInFrame': -1.0, 'ASName': 'PlayerCloseInWait'})
    EventSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 90})
    EventCamera.EventMoveCameraToSavePoint({'IsWaitEnd': True, 'CollisionInterpolateSkip': False, 'ReviseMode': 0, 'MoveFrame': 0, 'EnableCameraAlpha': False})
    GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': True, 'GameDataName': 'Connect_TabantaMaze_BossKilledOnce'})
    GameSystemActor.EventTriggerRequestAutoSave()
}
