-------- EventFlow: CollectObject_MiniGame_Cliff --------
...
entrypoint: None()
actions: ['EventWait', 'EventEventFadeOut', 'EventEventFadeIn', 'EventTriggerIncreaseRupee', 'EventCloseRupeeDisplay', 'EventOpenRupeeDisplay', 'EventResetGimmick', 'EventTriggerRequestAutoSave', 'EventWaitForActorPresence', 'EventWaitStableNumDisplay']
...
Actor: Npc_HighMountain041[Cliff]
entrypoint: None()
...
void Playing_Npc_MiniGame_CollectObject_Cliff_EachFrame() {
    Event144:
    if !GameDataActor.EventQueryIsGameDataEnum({'Value': 'Playing', 'GameDataName': 'Step_CollectObject_MiniGame_Cliff', 'Index': -1}) {
        ...
        if !ChallengeSystemActor.EventQueryMiniGameTimeOver() {
            ...
            ChallengeSystemActor.EventTriggerProgressChallengeStep({'StepName': 'TimeOver', 'IsIgnoreCompletedChallenge': True, 'IsIgnoreChallengeProgressUI': True, 'ChallengeName': 'CollectObject_MiniGame_Cliff'})
        } else
...
void Playing_Npc_MiniGame_CollectObject_Cliff_Talk() {
    ...
    if !GameSystemActor.EventQueryTalkChoice2() {
        ...
        if !GameSystemActor.EventQueryTalkChoice2() {
            ...
            Npc_HighMountain041[Cliff].EventTriggerChangeEmotion({'EmotionType': 0, 'IsActFaceOnly': False})
            Npc_HighMountain041[Cliff].EventAIScheduleWarpToAnchor({'IsWaitEnd': True, 'InstanceName': '', 'ActionType': 0, 'AnchorType': 0, 'ForceGetUpDuringSleep': True, 'ResetArrivalState': False, 'EnableArrivalState': False})
            Npc_HighMountain041[Cliff].EventNPCTurnToTarget({'Target': 2, 'FaceControlType': 0, 'IsWaitEnd': True, 'ActorName': '', 'InstanceName': '', 'WorldPos': [0.0, 0.0, 0.0], 'PosOffset': [0.0, 0.0, 0.0], 'Direction': 0.0, 'IsConfront': True, 'OffsetBase': 0, 'LookingControllerName': '', 'LookIKParameterVariationName': '', 'IsReleaseThreaten': False, 'EnableAutomaticallyPlayWaitASAfterTurn': True})
            ...
            ChallengeSystemActor.EventExecuteProgressChallengeStep({'IsIgnoreChallengeProgressUI': True, 'IsIgnoreCompletedChallenge': True, 'StepName': 'Ready', 'ChallengeName': 'CollectObject_MiniGame_Cliff', 'IsWaitEnd': True})
        } else {
            Event42:
...
void TimeOver_Npc_MiniGame_CollectObject_Cliff_StepStart() {
    if !ChallengeSystemActor.EventQueryMiniGameTimeOver() {
...
void MiniGame_CollectObject_Cliff_PlayerOutOfArea() {
    ...
    Npc_HighMountain041[Cliff].EventNPCTurnToObjectGreeting({'GreetType': 3, 'TurnType': 1, 'IsWaitEnd': True})
    ChallengeSystemActor.EventTriggerMiniGameTimerStop()
    ...
    Player.EventPlayerWait({'IsWaitEnd': True})
    Player.EventPlayerUnequip({'IsWaitEnd': True})
    Npc_HighMountain041[Cliff].EventNPCTurnToTarget({'Target': 2, 'IsWaitEnd': True, 'ActorName': '', 'InstanceName': '', 'WorldPos': [0.0, 0.0, 0.0], 'PosOffset': [0.0, 0.0, 0.0], 'Direction': 0.0, 'OffsetBase': 0, 'FaceControlType': 1, 'IsConfront': False, 'LookingControllerName': '', 'LookIKParameterVariationName': '', 'IsReleaseThreaten': False, 'EnableAutomaticallyPlayWaitASAfterTurn': True})

    call WarpDollsIfNotPlayableArea_Cliff()
...
void BlowingAway() {
    ...
    fork {
        Npc_HighMountain041[Cliff].EventTalk({'IsWaitEnd': True, 'IsCloseDialog': True, 'EndDialogOption': 0, 'IsAnimeDriven': False, 'IsPlayASAllSlot': False, 'ChoiceLabel3': 0, 'ChoiceLabel4': 0, 'ChoiceDefaultNo': 0, 'ChoiceCancelNo': 0, 'IsNotBecomeSpeaker': False, 'ChangeMstxtForActor': False, 'IsAnonymous': False, 'IsOverrideStyle': False, 'OverrideStyle': 0, 'ChoiceLabel1': 0, 'NotPlayLipSyncAnim': False, 'ChoiceLabel2': 1, 'ChoiceNumber': 0, 'MessageId': 'EventFlowMsg/CollectObject_MiniGame:Talk02', 'ASName': 'TalkSurprised', 'IsNotOpenIfSkipedMostRecent': False})
    } {
    ...
    Npc_HighMountain041[Cliff].EventNPCTurnToTarget({'Target': 2, 'IsWaitEnd': True, 'ActorName': '', 'InstanceName': '', 'WorldPos': [0.0, 0.0, 0.0], 'PosOffset': [0.0, 0.0, 0.0], 'Direction': 0.0, 'IsConfront': True, 'OffsetBase': 0, 'LookingControllerName': '', 'LookIKParameterVariationName': '', 'IsReleaseThreaten': False, 'EnableAutomaticallyPlayWaitASAfterTurn': True, 'FaceControlType': 1})
    GameSystemActor.EventEventFadeIn({'IsWaitEnd': True, 'IsNoPlayAnime': False, 'Color': 0, 'Length': 1})
}

void CleanUpByNpc() {
    GameSystemActor.EventEventFadeOut({'IsWaitEnd': True, 'IsNoPlayAnime': False, 'Color': 0, 'Length': 1})
    Npc_HighMountain041[Cliff].EventTriggerChangeEmotion({'IsActFaceOnly': False, 'EmotionType': 0})
    Npc_HighMountain041[Cliff].EventPlayAS({'ASName': 'Talk', 'IsWaitEnd': False, 'Partial': '', 'IsAllSlot': False, 'ForceFadeInFrame': -1.0, 'IsAnimeDriven': False})
    ...
    GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'GameDataName': 'CollectObject_MiniGame_IsAirWall', 'Value': False})
    EventCamera.EventSendEventTalkMessageToPlayerCamera({'IsWaitEnd': False})
    GameSystemActor.EventEventFadeIn({'IsWaitEnd': True, 'IsNoPlayAnime': False, 'Color': 0, 'Length': 1})
    Npc_HighMountain041[Cliff].EventTalk({'IsWaitEnd': True, 'IsCloseDialog': True, 'EndDialogOption': 0, 'ASName': '', 'IsAnimeDriven': False, 'IsPlayASAllSlot': False, 'ChoiceLabel3': 0, 'ChoiceLabel4': 0, 'ChoiceDefaultNo': 0, 'ChoiceCancelNo': 0, 'IsNotBecomeSpeaker': False, 'ChangeMstxtForActor': False, 'IsAnonymous': False, 'IsOverrideStyle': False, 'OverrideStyle': 0, 'ChoiceLabel1': 0, 'NotPlayLipSyncAnim': False, 'ChoiceLabel2': 1, 'ChoiceNumber': 0, 'MessageId': 'EventFlowMsg/CollectObject_MiniGame:Talk14_1', 'IsNotOpenIfSkipedMostRecent': False})
    Npc_HighMountain041[Cliff].EventTalk({'IsWaitEnd': True, 'IsCloseDialog': True, 'EndDialogOption': 0, 'ASName': '', 'IsAnimeDriven': False, 'IsPlayASAllSlot': False, 'ChoiceLabel3': 0, 'ChoiceLabel4': 0, 'ChoiceDefaultNo': 0, 'ChoiceCancelNo': 0, 'IsNotBecomeSpeaker': False, 'ChangeMstxtForActor': False, 'IsAnonymous': False, 'IsOverrideStyle': False, 'OverrideStyle': 0, 'ChoiceLabel1': 0, 'NotPlayLipSyncAnim': False, 'ChoiceLabel2': 1, 'ChoiceNumber': 0, 'MessageId': 'EventFlowMsg/CollectObject_MiniGame:Talk14_2', 'IsNotOpenIfSkipedMostRecent': False})
...
void LupeePay() {
    if !GameSystemActor.EventQueryHasRuppe({'Value': 20}) {
        ...
        Npc_HighMountain041[Cliff].EventTriggerChangeEmotion({'IsActFaceOnly': False, 'EmotionType': 0})
        Npc_HighMountain041[Cliff].EventPlayAS({'IsWaitEnd': False, 'Partial': '', 'IsAllSlot': False, 'ForceFadeInFrame': -1.0, 'IsAnimeDriven': False, 'ASName': 'Wait'})
        GameSystemActor.EventResetGimmick({'IsWaitEnd': True, 'IsResetCamera': False, 'Option': 0})
...
void MiniGame_CollectObject_Cliff_OwningObjectMoved() {
    if !GameDataActor.EventQueryIsGameDataEnum({'Index': -1, 'Value': 'Ready', 'GameDataName': 'Step_CollectObject_MiniGame_Cliff'}) {
        Event81:

        call Common.AirStartUP_Player()

        Event84:
        Npc_HighMountain041[Cliff].EventNPCTurnToObjectGreeting({'IsWaitEnd': True, 'GreetType': 3, 'TurnType': 3})
        ...
        Npc_HighMountain041[Cliff].EventDisableRecentTalkFlag({'IsWaitEnd': True})
    }
}

void Ready_Npc_MiniGame_CollectObject_Cliff_Near() {
    if !Npc_HighMountain041[Cliff].EventQueryIsOnRecentTalkFlag() {
...
void Ready_Npc_MiniGame_CollectObject_Cliff_Talk() {
    ...
    if !Npc_HighMountain041[Cliff].EventQueryIsOnRecentTalkFlag() {
        ...
        switch EventWorldManagerController.EventQueryTimeDivision() {
          case [0, 1]:
            ...
            if !GameSystemActor.EventQueryTalkChoice2() {
                GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'GameDataName': 'CollectObject_MiniGame_IsAirWall', 'Value': True})

                call WaitCreateAirWall()
                    ...
                    switch EventWorldManagerController.EventQueryWeather({'IsCheckRainRate': True}) {
                      case [0, 1, 4, 5, 8]:
                        ...
                        if !GameDataActor.EventQueryIsGameDataBool({'GameDataName': 'CollectObject_MiniGame_FirstTake', 'Index': -1}) {
                            ...
                            if !GameDataActor.EventQueryIsGameDataBool({'Index': -1, 'GameDataName': 'CollectObject_MiniGame_Cliff_IsFinishedFirstTake'}) {
                                if !GameDataActor.EventQueryIsGameDataBool({'Index': -1, 'GameDataName': 'CollectObject_MiniGame_Cliff_IsFinishedSecondTake'}) {
                                    Event262:
                                ...
                                if !GameSystemActor.EventQueryTalkChoice2() {
                                    ...
                                    GameSystemActor.EventEventFadeOut({'IsWaitEnd': True, 'IsNoPlayAnime': False, 'Color': 0, 'Length': 1})
                                    Npc_HighMountain041[Cliff].EventAIScheduleWarpToAnchor({'AnchorType': 2, 'IsWaitEnd': True, 'InstanceName': '', 'ActionType': 0, 'ForceGetUpDuringSleep': True, 'ResetArrivalState': False, 'EnableArrivalState': False})
                                    ...
                                    ChallengeSystemActor.EventExecuteProgressChallengeStep({'StepName': 'Playing', 'IsIgnoreChallengeProgressUI': True, 'IsIgnoreCompletedChallenge': True, 'ChallengeName': 'CollectObject_MiniGame_Cliff', 'IsWaitEnd': True})
                                } else {
                                    GameSystemActor.EventCloseRupeeDisplay({'IsWaitEnd': True})
                            ...
                            if !GameSystemActor.EventQueryTalkChoice2() {
                                ...
                                Npc_HighMountain041[Cliff].EventNPCTurnToTarget({'Target': 2, 'WorldPos': [0.0, 0.0, 0.0], 'IsWaitEnd': True, 'FaceControlType': 1, 'ActorName': '', 'InstanceName': '', 'PosOffset': [0.0, 0.0, 0.0], 'Direction': 0.0, 'IsConfront': True, 'OffsetBase': 0, 'LookingControllerName': '', 'LookIKParameterVariationName': '', 'IsReleaseThreaten': False, 'EnableAutomaticallyPlayWaitASAfterTurn': True})
                                Player.EventTriggerPlayerLookAtObject({'Target': 3, 'ActorName': 'Npc_HighMountain041', 'TurnFaceControlType': 1, 'WorldPos': [0.0, 0.0, 0.0], 'PosOffset': [0.0, 0.0, 0.0], 'Direction': 0.0, 'InstanceName': 'Cliff'})
                                EventCamera.EventMoveCameraToSavePoint({'IsWaitEnd': True, 'MoveFrame': 0, 'CollisionInterpolateSkip': False, 'ReviseMode': 0, 'EnableCameraAlpha': False})
...
void MiniGame_CollectObject_Cliff_OwningObjectInterferedByPlayer() {
    ...
    switch Npc_HighMountain041[Cliff].EventQueryOwningObjectPlayerInterference({'IsCheckBrokenInterferedOnly': False}) {
      case [0, 1, 2, 3, 4, 7]:
        goto Event81
      case 5:
      ...
      case [6, 8, 9]:
        ...
        call MiniGame_CollectObject_Cliff_Burn()

    }
}

void ParticipateEventAndBlowingAway() {
    AsbObj_WagonSteeringCollectObject_A_01[Wagon_Steering_NotPlayingMiniGame].EventTriggerSetVelToBlowingAway({'AddVelocity': [0.0, 8.0, 0.0]})
    Harness_Coupler[Coupler_ForCollectObject].EventTriggerSetVelToBlowingAway({'AddVelocity': [0.0, 8.0, 0.0]})
    TwnObj_GerudoDollBlue_A_02_CollectObject[DollForBlowAway00].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway00_Cliff'})
    TwnObj_GerudoDollBlue_A_02_CollectObject[DollForBlowAway01].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway01_Cliff'})
    TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway02].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway02_Cliff'})
    TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway03].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway03_Cliff'})
    TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway04].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway04_Cliff'})
    TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway05].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway05_Cliff'})
    TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway06].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway06_Cliff'})
    TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway07].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway07_Cliff'})
    TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway08].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway08_Cliff'})
    TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway09].EventTriggerSetDestinationAnchorToBlowingAway({'Angle': 80.0, 'BasicParamNameOfAnchor': 'DollForBlowAway09_Cliff'})
    GameSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 5})
...
void MiniGame_CollectObject_Cliff_Burn() {
    Event366:
    ...
    Npc_HighMountain041[Cliff].EventNPCTurnToObjectGreeting({'IsWaitEnd': True, 'GreetType': 3, 'TurnType': 3})
    if !GameDataActor.EventQueryIsGameDataEnum({'Index': -1, 'Value': 'Playing', 'GameDataName': 'Step_CollectObject_MiniGame_Cliff'}) {
    ...
    ChallengeSystemActor.EventExecuteProgressChallengeStep({'IsIgnoreCompletedChallenge': True, 'ChallengeName': 'CollectObject_MiniGame_Cliff', 'IsIgnoreChallengeProgressUI': False, 'IsWaitEnd': True, 'StepName': 'Ready'})
}

void Camera_LookWagon() {
    Npc_HighMountain041[Cliff].EventNPCTurnToTarget({'IsWaitEnd': True, 'Target': 3, 'FaceControlType': 1, 'InstanceName': 'Wagon_Steering_NotPlayingMiniGame', 'WorldPos': [0.0, 0.0, 0.0], 'PosOffset': [0.0, 0.0, 0.0], 'Direction': 0.0, 'IsConfront': True, 'LookingControllerName': '', 'LookIKParameterVariationName': '', 'OffsetBase': 0, 'IsReleaseThreaten': False, 'EnableAutomaticallyPlayWaitASAfterTurn': True, 'ActorName': 'AsbObj_WagonSteeringCollectObject_A_01'})
    ...
    EventCamera.EventMoveToTargetPosCamera({'IsWaitEnd': True, 'StartAccelerateRate': 0.0, 'EndRecelerateRate': 0.0, 'IsLinearMove': False, 'Actor2InstanceName': 'Wagon_Steering_NotPlayingMiniGame', 'Actor1ActorName': 'Npc_HighMountain041', 'IsIgnorePosVectorReferenceActorRot': False, 'IsPosVectorReferenceActorPosOnce': False, 'IsIgnoreAtVectorReferenceActorRot': False, 'IsAtVectorReferenceActorPosOnce': False, 'MoveTotargetPosType': 0, 'LatShiftRange': 0.0, 'LongShiftRange': 0.0, 'Actor1InstanceName': '', 'PosVectorSetType': 0, 'AtVectorSetType': 0, 'CameraCollisionMode': 0, 'MoveTime': 30, 'TargetFovy': 40.0, 'AtVector': [4279.93994140625, 339.45001220703125, -828.3599853515625], 'PosVector': [4280.89013671875, 339.8500061035156, -831.1300048828125], 'CameraCollisionLookAtActor': 0, 'CameraCollisionLookAtActorOffset': [0.0, 1.5, 0.0], 'EnableCameraAlpha': False, 'Actor2ActorName': 'AsbObj_WagonSteeringCollectObject_A_01'})
}

void Camera_OverlookSctteredDools() {
    EventCamera.EventMoveToTargetPosCamera({'IsWaitEnd': True, 'Actor1InstanceName': '', 'Actor2ActorName': '', 'Actor2InstanceName': '', 'StartAccelerateRate': 0.0, 'EndRecelerateRate': 0.0, 'IsLinearMove': False, 'IsPosVectorReferenceActorPosOnce': False, 'IsAtVectorReferenceActorPosOnce': False, 'MoveTotargetPosType': 0, 'Actor1ActorName': 'Player', 'IsIgnorePosVectorReferenceActorRot': False, 'IsIgnoreAtVectorReferenceActorRot': False, 'LatShiftRange': 0.0, 'LongShiftRange': 0.0, 'PosVectorSetType': 0, 'AtVectorSetType': 0, 'CameraCollisionMode': 0, 'PosVector': [4271.3701171875, 342.3699951171875, -828.75], 'AtVector': [4267.64990234375, 337.2200012207031, -828.27001953125], 'TargetFovy': 50.0, 'MoveTime': 30, 'CameraCollisionLookAtActor': 0, 'CameraCollisionLookAtActorOffset': [0.0, 1.5, 0.0], 'EnableCameraAlpha': False})
}

void Playing_Npc_HighMountain041_Cliff_Near() {
...
void WaitCreateAirWall() {
    GameSystemActor.EventWaitForActorPresence({'ActorName': 'AirWallMiniGame', 'IsWaitEnd': True, 'InstanceName': 'CollectObject_Cliff_AirWall_00'})
    GameSystemActor.EventWaitForActorPresence({'ActorName': 'AirWallMiniGame', 'IsWaitEnd': True, 'InstanceName': 'CollectObject_Cliff_AirWall_01'})
    GameSystemActor.EventWaitForActorPresence({'ActorName': 'AirWallMiniGame', 'IsWaitEnd': True, 'InstanceName': 'CollectObject_Cliff_AirWall_02'})
}

void NpcTurnToHorse() {
    Npc_HighMountain041[Cliff].EventNPCTurnToTarget({'ActorName': 'Animal_Horse_B', 'InstanceName': 'Horse_NotPlayingMiniGame', 'PosOffset': [0.0, 0.0, 0.0], 'Direction': 0.0, 'OffsetBase': 0, 'IsWaitEnd': True, 'FaceControlType': 1, 'IsConfront': True, 'LookingControllerName': '', 'LookIKParameterVariationName': '', 'Target': 0, 'WorldPos': [4278.30908203125, 337.2008056640625, -828.52978515625], 'IsReleaseThreaten': False, 'EnableAutomaticallyPlayWaitASAfterTurn': True})
}

void MiniGame_CollectObject_Cliff_DollsOutOfArea() {
    goto Event366
}

void Camera_Action1_Talk() {
    EventCamera.EventMoveToTargetPosCamera({'IsAtVectorReferenceActorPosOnce': True, 'IsPosVectorReferenceActorPosOnce': True, 'IsWaitEnd': True, 'Actor2ActorName': '', 'Actor2InstanceName': '', 'MoveTime': 0, 'StartAccelerateRate': 0.0, 'EndRecelerateRate': 0.0, 'IsLinearMove': False, 'MoveTotargetPosType': 0, 'CameraCollisionMode': 1, 'LatShiftRange': 0.0, 'LongShiftRange': 0.0, 'Actor1ActorName': 'Npc_HighMountain041', 'Actor1InstanceName': 'Cliff', 'PosVector': [2.2799999713897705, 1.909999966621399, 5.050000190734863], 'AtVector': [0.019999999552965164, 1.3300000429153442, 1.1699999570846558], 'TargetFovy': 40.0, 'PosVectorSetType': 3, 'AtVectorSetType': 3, 'IsIgnorePosVectorReferenceActorRot': False, 'IsIgnoreAtVectorReferenceActorRot': False, 'CameraCollisionLookAtActor': 0, 'CameraCollisionLookAtActorOffset': [0.0, 1.5, 0.0], 'EnableCameraAlpha': False})
}

void Camera_Action2_Talk() {
    EventCamera.EventMoveToTargetPosCamera({'IsAtVectorReferenceActorPosOnce': True, 'IsPosVectorReferenceActorPosOnce': True, 'IsWaitEnd': True, 'Actor2ActorName': '', 'Actor2InstanceName': '', 'MoveTime': 0, 'StartAccelerateRate': 0.0, 'EndRecelerateRate': 0.0, 'IsLinearMove': False, 'MoveTotargetPosType': 0, 'CameraCollisionMode': 1, 'LatShiftRange': 0.0, 'LongShiftRange': 0.0, 'Actor1ActorName': 'Npc_HighMountain041', 'Actor1InstanceName': 'Cliff', 'PosVector': [4.409999847412109, 1.6299999952316284, 0.18000000715255737], 'AtVector': [-0.4000000059604645, 1.4900000095367432, 2.640000104904175], 'TargetFovy': 50.0, 'PosVectorSetType': 3, 'AtVectorSetType': 3, 'IsIgnorePosVectorReferenceActorRot': False, 'IsIgnoreAtVectorReferenceActorRot': False, 'CameraCollisionLookAtActor': 0, 'CameraCollisionLookAtActorOffset': [0.0, 1.5, 0.0], 'EnableCameraAlpha': False})
}

void Camera_BeforePlaying() {
    EventCamera.EventMoveToTargetPosCamera({'IsWaitEnd': True, 'Actor2ActorName': '', 'Actor2InstanceName': '', 'IsPosVectorReferenceActorPosOnce': False, 'IsAtVectorReferenceActorPosOnce': False, 'StartAccelerateRate': 0.0, 'EndRecelerateRate': 0.0, 'IsLinearMove': False, 'MoveTotargetPosType': 0, 'CameraCollisionMode': 1, 'LatShiftRange': 0.0, 'LongShiftRange': 0.0, 'Actor1InstanceName': '', 'MoveTime': 0, 'Actor1ActorName': 'Player', 'PosVector': [-0.14000000059604645, 3.0899999141693115, -4.960000038146973], 'AtVector': [-0.14000000059604645, 1.7999999523162842, 0.10999999940395355], 'TargetFovy': 50.0, 'PosVectorSetType': 3, 'AtVectorSetType': 3, 'IsIgnorePosVectorReferenceActorRot': False, 'IsIgnoreAtVectorReferenceActorRot': False, 'CameraCollisionLookAtActor': 0, 'CameraCollisionLookAtActorOffset': [0.0, 1.5, 0.0], 'EnableCameraAlpha': False})
}
    ...
    if !GameDataActor.EventQueryCompareGameDataInt({'GameDataB': 'CollectObject_MiniGame_MaxGoodsNum', 'Operator': 3, 'GameDataA': 'CollectObject_MiniGame_CurrentScore_SunaDoll'}) {
        ...
        if !GameDataActor.EventQueryIsGameDataBool({'Index': -1, 'GameDataName': 'CollectObject_MiniGame_Cliff_IsFinishedFirstTake'}) {
            if !GameDataActor.EventQueryIsGameDataBool({'Index': -1, 'GameDataName': 'CollectObject_MiniGame_Cliff_IsFinishedSecondTake'}) {
                ...
                GameSystemActor.EventEventFadeIn({'IsWaitEnd': True, 'IsNoPlayAnime': False, 'Color': 0, 'Length': 1})
                ChallengeSystemActor.EventTriggerRollbackChallengeStep({'IsIgnoreCompletedChallenge': True, 'ChallengeStep': 'Ready', 'ChallengeName': 'CollectObject_MiniGame_Cliff', 'IsIgnoreChallengeProgressUI': False})
                GameSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 2})
                GameSystemActor.EventTriggerRequestAutoSave()
            } else {
                GameDataActor.EventTriggerSetGameDataBool({'Value': True, 'Index': -1, 'GameDataName': 'CollectObject_MiniGame_Cliff_IsFinishedSecondTake'})
                Npc_HighMountain041[Cliff].EventTalk({'IsWaitEnd': True, 'IsCloseDialog': True, 'EndDialogOption': 0, 'ASName': '', 'IsAnimeDriven': False, 'IsPlayASAllSlot': False, 'ChoiceLabel3': 0, 'ChoiceLabel4': 0, 'ChoiceDefaultNo': 0, 'ChoiceCancelNo': 0, 'IsNotBecomeSpeaker': False, 'ChangeMstxtForActor': False, 'IsAnonymous': False, 'IsOverrideStyle': False, 'OverrideStyle': 0, 'ChoiceNumber': 0, 'ChoiceLabel1': 0, 'ChoiceLabel2': 0, 'NotPlayLipSyncAnim': False, 'MessageId': 'EventFlowMsg/CollectObject_MiniGame:Talk11_3', 'IsNotOpenIfSkipedMostRecent': False})
                goto Event62
            }
        } else {
            GameDataActor.EventTriggerSetGameDataBool({'Value': True, 'Index': -1, 'GameDataName': 'CollectObject_MiniGame_Cliff_IsFinishedFirstTake'})
            goto Event62
        }
    } else
    switch GameDataActor.EventQueryIsGameDataInt({'GameDataName': 'CollectObject_MiniGame_CurrentScore_SunaDoll', 'Index': -1, 'Value': 4}) {
      case [0, 1]:
        Npc_HighMountain041[Cliff].EventTalk({'IsWaitEnd': True, 'IsCloseDialog': True, 'EndDialogOption': 0, 'ASName': '', 'IsAnimeDriven': False, 'IsPlayASAllSlot': False, 'ChoiceLabel3': 0, 'ChoiceLabel4': 0, 'ChoiceDefaultNo': 0, 'ChoiceCancelNo': 0, 'IsNotBecomeSpeaker': False, 'ChangeMstxtForActor': False, 'IsAnonymous': False, 'IsOverrideStyle': False, 'OverrideStyle': 0, 'ChoiceNumber': 0, 'ChoiceLabel1': 0, 'ChoiceLabel2': 0, 'NotPlayLipSyncAnim': False, 'MessageId': 'EventFlowMsg/CollectObject_MiniGame:Talk11_2', 'IsNotOpenIfSkipedMostRecent': False})
        Event22:
...
void WarpDollsIfNotPlayableArea_Cliff() {
    if !TwnObj_GerudoDollBlue_A_02_CollectObject[DollForBlowAway00].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollBlue_A_02_CollectObject[DollForBlowAway00].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway00_Cliff'})
    }
    if !TwnObj_GerudoDollBlue_A_02_CollectObject[DollForBlowAway01].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollBlue_A_02_CollectObject[DollForBlowAway01].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway01_Cliff'})
    }
    if !TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway02].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway02].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway02_Cliff'})
    }
    if !TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway03].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway03].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway03_Cliff'})
    }
    if !TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway04].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway04].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway04_Cliff'})
    }
    if !TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway05].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway05].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway05_Cliff'})
    }
    if !TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway06].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollSmallRed_A_01_CollectObject[DollForBlowAway06].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway06_Cliff'})
    }
    if !TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway07].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway07].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway07_Cliff'})
    }
    if !TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway08].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway08].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway08_Cliff'})
    }
    if !TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway09].EventQueryGerudoDollIsNotInPlayableArea() {
        TwnObj_GerudoDollSmallGreen_A_01_CollectObject[DollForBlowAway09].EventTriggerWarpToNearAnchor({'InstanceName': 'DollForBlowAway09_Cliff'})
    }
}
