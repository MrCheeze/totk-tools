-------- EventFlow: FldObj_MessageBottle_01 --------

Actor: Npc_EventStarter
entrypoint: None()
actions: ['EventTriggerBecomeSpeaker', 'EventTalk', 'EventTriggerPushPauseMask', 'EventTriggerErasePauseMask']
queries: []
...
Actor: Player
entrypoint: None()
actions: ['EventPlayerTalk', 'EventPlayerOnSurfaceVelocityFloatWater', 'EventPlayerOffSurfaceVelocityFloatWater']
queries: []
...
void Talk() {
    ...
    Npc_EventStarter.EventTalk({'MessageId': 'EventFlowMsg/FldObj_MessageBottle:GerudoPot_01', 'IsWaitEnd': True, 'IsCloseDialog': True, 'EndDialogOption': 0, 'ASName': '', 'IsAnimeDriven': False, 'IsPlayASAllSlot': False, 'ChoiceNumber': 0, 'ChoiceLabel1': 0, 'ChoiceLabel2': 0, 'ChoiceLabel3': 0, 'ChoiceLabel4': 0, 'ChoiceDefaultNo': 0, 'ChoiceCancelNo': 0, 'IsNotBecomeSpeaker': False, 'ChangeMstxtForActor': False, 'IsAnonymous': False, 'NotPlayLipSyncAnim': False, 'IsOverrideStyle': False, 'OverrideStyle': 0, 'IsNotOpenIfSkipedMostRecent': False})
