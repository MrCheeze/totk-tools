...
void Dm_ZN_0049() {
    if !GameDataActor.EventQueryIsGameDataBoolExp({'GameDataName': 'SageOfSoul_IsAfter_CarryHead_CheckPoint04_Exp'}) {
        ...
        call Dm_ZN_0051.Terminal_Sweep({'GameDataName': 'SageOfSoul_Terminal_Sweep_2'})


        call Dm_ZN_0051.Container_Sweep({'AnchorActorName': 'DesignateMatrixActor', 'AnchorInstanceName': 'Container_Sweep_2', 'GameDataName': 'SageOfSoul_Container_Sweep_2'})

        GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': True, 'GameDataName': 'SageOfSoul_AirWallOn'})
        if !GameDataActor.EventQueryIsGameDataBool({'Index': -1, 'GameDataName': 'SageOfSoul_SwitchedSatelliteTempleDoor_2'}) {
            GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': True, 'GameDataName': 'SageOfSoul_TerminalOn_RightArmContainer_Respawn'})
            ...
            GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'GameDataName': 'SageOfSoul_TerminalOn_RightArmContainer_Respawn', 'Value': False})
            GameSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 1})
        } else {
            GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': False, 'GameDataName': 'SageOfSoul_ClosedSatelliteTempleDoor_RightArm'})
            ...
            GameDataActor.EventTriggerSetGameDataBool({'Value': True, 'Index': -1, 'GameDataName': 'SageOfSoul_SwitchedSatelliteTempleDoor2_2'})
            GameSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 48})
            GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': False, 'GameDataName': 'SageOfSoul_SwitchedSatelliteTempleDoor2_2'})
            ...
            EventCamera.EventMoveCameraAnimationInstructionsForFlowchart({'SceneName': 'C02-0', 'RootType': 3, 'TargetActorName': 'DgnObj_Terminal_A_04', 'IsWaitEnd': True, 'CameraName': '', 'IsIgnoreRootRot': False, 'IsReferenceRootOnce': False, 'TargetActorInstanceName': '', 'OverwriteStartFrame': -1.0, 'OverwriteEndFrame': -1.0, 'IsLoop': False, 'InterpolateFrame': 0.0, 'CalcUpInInterpolate': False})
            GameSystemActor.EventWait({'Frames': 5, 'IsWaitEnd': True})
            GameDataActor.EventTriggerSetGameDataBool({'Index': -1, 'Value': True, 'GameDataName': 'SageOfSoul_ClosedSatelliteTempleDoor_RightArm'})
            GameSystemActor.EventWait({'Frames': 30, 'IsWaitEnd': True})

            fork {
                EventCamera.EventMoveCameraAnimationInstructionsForFlowchart({'RootType': 3, 'TargetActorName': 'DgnObj_Terminal_A_04', 'IsWaitEnd': True, 'CameraName': '', 'IsIgnoreRootRot': False, 'IsReferenceRootOnce': False, 'TargetActorInstanceName': '', 'OverwriteStartFrame': -1.0, 'OverwriteEndFrame': -1.0, 'IsLoop': False, 'InterpolateFrame': 0.0, 'SceneName': 'C03-0', 'CalcUpInInterpolate': False})
            } {
                GameSystemActor.EventWait({'Frames': 5, 'IsWaitEnd': True})
                GameDataActor.EventTriggerSetGameDataBool({'Value': True, 'Index': -1, 'GameDataName': 'SageOfSoul_SwitchedSatelliteTempleDoor_2'})
                GameSystemActor.EventWait({'IsWaitEnd': True, 'Frames': 60})
                GameDataActor.EventTriggerSetGameDataBool({'Value': True, 'Index': -1, 'GameDataName': 'SageOfSoul_OpenedSatelliteTempleExit_RightArm'})
            }
