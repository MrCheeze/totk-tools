...
Actor: TwnObj_Village_Hatenodoor_A_02
entrypoint: None()
...
Actor: Player
entrypoint: None()
actions: ['EventTriggerPlayerLookAtObject', 'EventPlayerUnequip']
queries: []
...
void EntryPoint0() {
    TwnObj_Village_Hatenodoor_A_02.EventTriggerParticipateEvent()

    fork {
        Player.EventPlayerUnequip({'IsWaitEnd': True})
        Player.EventTriggerPlayerLookAtObject({'TurnFaceControlType': 1, 'PosOffset': [0.0, 0.0, 0.0], 'Direction': 0.0, 'InstanceName': '', 'Target': 0, 'ActorName': '', 'WorldPos': [3361.0, 227.89999389648438, 2128.39990234375]})
    } {
