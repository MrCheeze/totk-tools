-------- EventFlow: Npc_Zonau_Golem_Servant_FirstIsland_01 --------

Actor: Npc_Zonau_Golem_Servant_FirstIsland_01
entrypoint: None()
actions: ['EventTalk']
queries: []
